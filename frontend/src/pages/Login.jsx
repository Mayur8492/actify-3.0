    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8 mt-4">
          ...
          <p className="text-textSecondary">Sign in to your Actify account</p>
        </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-card text-textSecondary">Or continue with</span>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              type="button"
              onClick={() => {
                setInfoMessage('Social login is coming soon! Please use email and password for now.');
